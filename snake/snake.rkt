...
(define HEAD-IMG (bitmap/file "assets/head.gif"))
(define GOO-IMG (bitmap/file "assets/goo.gif"))
(define SEG-IMG (bitmap/file "assets/body.gif"))
...
(define pit-example
  (pit snake-example goos-example))
...
(define (snake+scene snake scene)
  ...
  (img+scene (snake-head snake)
             (cond [(string=? "up" dir) HEAD-IMG]
                   [(string=? "down" dir) HEAD-IMG]
                   [(string=? "left" dir) HEAD-IMG]
                   [(string=? "right" dir) HEAD-IMG])
             snake-body-scene))
